...
export class Migration20230516052920_Create_Account extends Migration {
    async up(): Promise<void> {
        ...
        this.addSql('alter table "accounts" add constraint "accounts_full_name_unique" unique ("first_name", "last_name");');
    }
