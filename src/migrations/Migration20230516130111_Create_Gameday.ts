...
export class Migration20230516130111_Create_Gameday extends Migration {
    async up(): Promise<void> {
        ...
        this.addSql('alter table "gamedays" add constraint "gamedays_title_unique" unique ("title");');
        this.addSql('alter table "gamedays" add constraint "gamedays_order_number_unique" unique ("order_number");');
    }
